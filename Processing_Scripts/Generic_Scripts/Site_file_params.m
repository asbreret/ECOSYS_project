...
site_parameters.water_table_flag = 1.0; % 0: No water table, 1: Water table present
...
site_parameters.grid_cell_interconnected = 3; % Grid cells interconnected (choice: 1.3)
site_parameters.external_water_table_height = 1.3; % Depth of external water table (meters)
site_parameters.artificial_drainage_depth = 100.0; % Depth for artificial drainage (meters)
...
site_parameters.sbc_east = 0.0; % Eastern surface boundary runoff (choice: 0.1)
...
site_parameters.water_table_dist_east = 0.1; % Distance to external water table from the eastern boundary (meters)
...
site_parameters.lbc_east = 0.0; % Eastern subsurface boundary movement (choice: 0.0)
